       ...
       <?php
         ...
         ?> 
            <form method="post" action="optservice.php">
                   ...
                   <input id="fixed-price" type="radio"  value="<?php echo $row['fixed']; ?>" name="cost_type" checked>
                            ...
                            <br><br>
                            <textarea id="summernote1" class="form-control" name="summer_note"><?php echo $row['summer_note']; ?></textarea>
