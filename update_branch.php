<?php include("header/htmlheader.php");
   ...
   include("extra.php");
?>
<?php  include("operation_login.php"); ?>
<body>
...
<div class="modal add-new-branch-modal fade open in" tabindex="-1" role="dialog" aria-labelledby="" style="display: block; background: rgba(0, 0, 0, 0.3);">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <button class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><a href="our-branches.php">X</a></span></button>
        ...
        <div class="modal-body new-branch-modal-body">
            ...
            <select class="selectpicker" name="country" data-live-search="true" data-header="Select branch country" title="Country">
                        <option data-tokens="ketchup mustard"><?php echo $row['country']; ?></option>
            </select>
         ...
         <input type="text" name="app"  value="<?php echo $row['app']; ?>" placeholder="App/Suite #" class="app-suite-input">
            <input type="text" name="state" value="<?php echo $row['state']; ?>" placeholder="State">
            <input type="text" name="postal_code" value="<?php echo $row['postal_code']; ?>" placeholder="Postal code">
